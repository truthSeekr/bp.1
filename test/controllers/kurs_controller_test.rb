...
class KursControllerTest < ActionController::TestCase
  ...
  test "should create kur" do
    assert_difference('Kur.count') do
      post :create, kur: { miejsce: @kur.miejsce, nazwa: @kur.nazwa, opis: @kur.opis, termin: @kur.termin }
    end
  ...
  test "should update kur" do
    patch :update, id: @kur, kur: { miejsce: @kur.miejsce, nazwa: @kur.nazwa, opis: @kur.opis, termin: @kur.termin }
    assert_redirected_to kur_path(assigns(:kur))
  end
